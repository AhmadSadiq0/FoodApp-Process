//This folder exports contains the Notifications screens that make up APP's user interface. 
...
//     console.log("Current user ID from AuthStore:", currentUserId); // Log the current user ID
...
//                 <View
//                     style={[styles.circle, !item.seen && { backgroundColor: THEME_COLOR }]}
//                 />
//             </View>
//         </TouchableOpacity>
//     );
